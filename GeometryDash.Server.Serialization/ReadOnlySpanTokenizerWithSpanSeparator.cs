...
public ref struct ReadOnlySpanTokenizerWithSpanSeparator<T>
    where T : IEquatable<T>
{
    ...
    public ReadOnlySpanTokenizerWithSpanSeparator(ReadOnlySpan<T> span, ReadOnlySpan<T> separator)
    {
        this.span = span;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ReadOnlySpanTokenizerWithSpanSeparator<T> GetEnumerator() => this;
    ...
    {
        int newEnd = this.end + this.separator.Length;
